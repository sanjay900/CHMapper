...
#include <map>
static std::map<int, const char*> ev_map= {
	{EV_SYN,"EV_SYN"},
	{EV_KEY,"EV_KEY"},
	{EV_REL,"EV_REL"},
	{EV_ABS,"EV_ABS"},
...
static std::map<int, const char*> rel_map= {
	{REL_X,"REL_X"},
	{REL_Y,"REL_Y"},
	{REL_Z,"REL_Z"},
	{REL_RX,"REL_RX"},
...
static std::map<int, const char*> abs_map= {
	{ABS_X,"ABS_X"},
	{ABS_Y,"ABS_Y"},
	{ABS_Z,"ABS_Z"},
	{ABS_RX,"ABS_RX"},
...
static std::map<int, const char*> key_map= {
...
static std::map<int, const char*> led_map= {
	{LED_NUML,"LED_NUML"},
	{LED_CAPSL,"LED_CAPSL"},
...
static std::map<int, const char*> snd_map= {
	{SND_CLICK,"SND_CLICK"},
	{SND_BELL,"SND_BELL"},
	{SND_TONE,"SND_TONE"},
	{SND_MAX,"SND_MAX"},
...
static std::map<int, const char*> msc_map= {
...
static std::map<int, const char*> sw_map= {
	{SW_LID,"SW_LID"},
...
static std::map<int, const char*> ff_map= {
...
static std::map<int, const char*> syn_map= {
...
static std::map<int, const char*> rep_map= {
	{REP_DELAY,"REP_DELAY"},
	{REP_PERIOD,"REP_PERIOD"},
};

static std::map<int, const char*> input_prop_map= {
...
static std::map<int, std::map<int, const char*>> event_type_map = {
	{EV_REL,rel_map},
	{EV_ABS,abs_map},
	{EV_KEY,key_map},
	{EV_LED,led_map},
...
static std::map<int, const int> ev_max = {
	{EV_REL,REL_MAX},
	{EV_ABS,ABS_MAX},
	{EV_KEY,KEY_MAX},
	{EV_LED,LED_MAX},
